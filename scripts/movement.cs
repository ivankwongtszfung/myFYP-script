...
public class movement : MonoBehaviour {
    ...
    private void FixedUpdate()
    {
        ...
        //Debug.Log(m_Camera.transform.localRotation * Quaternion.Euler(0, 90, 0));

        //transform.rotation = Quaternion.Euler(0, m_Camera.transform.rotation.eulerAngles.y, 0);
        //transform.rotation = Quaternion.Euler(0, (int)m_Camera.transform.rotation.eulerAngles.y, 0);
        if (!GUIEnable) {
    ...
    private void PlayFootStepAudio()
    {
        ...
        Debug.Log(n);
        Debug.Log(m_FootstepSounds.Length);
